...
const bestSport = country => {
  return `SELECT sport, COUNT(*) AS count FROM GoldMedal WHERE country = ${country} AND GROUP BY sport ORDER BY count LIMIT 1;`;
};
...
const bestEvent = country => {
  return `SELECT event, COUNT(*) AS count FROM GoldMedal WHERE country = ${country} GROUP BY event ORDER BY count LIMIT 1;`;
};
...
const numberMenMedalists = country => {
  return `SELECT COUNT(*) FROM GoldMedal WHERE country = ${country} and gender = male;`;
};
...
const numberWomenMedalists = country => {
  return `SELECT COUNT(DISTINCT name) FROM GoldMedal WHERE country = ${country} and gender = female;`;
};
